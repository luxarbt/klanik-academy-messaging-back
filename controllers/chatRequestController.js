...
exports.newChatRequest = async function (req, res, next) {
    try {
        ...
        const savedChatRequest = await ChatRequestService.newChatRequest(userRequesting, userRequested, status);
...
exports.updateChatRequest = async function (req, res, next) {
    try {
        ...
        const updatedChatRequest = await ChatRequestService.updateChatRequest(chatRequestId, status);
...
exports.getChatRequestsByUserRequested = async function (req, res, next) {
    try {
        ...
        const chatRequests = await ChatRequestService.getChatRequestsByUserRequested(userData);
...
exports.getChatRequestsByUserRequesting = async function (req, res, next) {
    try {
        ...
        const chatRequests = await ChatRequestService.getChatRequestsByUserRequesting(userData);
        res.json(chatRequests);
    } catch (err) {
        res.status(500).json({ error: err.message });
    }
